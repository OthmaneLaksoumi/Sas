...
CREATE TABLE `commande` (
  ...
  `product_refrence` int(5) UNSIGNED ZEROFILL NOT NULL,
...
ALTER TABLE `commande`
  ...
  ADD KEY `fk_product` (`product_refrence`),
...
ALTER TABLE `commande`
  ...
  ADD CONSTRAINT `fk_product` FOREIGN KEY (`product_refrence`) REFERENCES `products` (`reference`) ON DELETE CASCADE ON UPDATE CASCADE;
